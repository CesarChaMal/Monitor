...
public class Campana extends Entidad {
	...
	public Query traerQuery(EntityManager entityManager) {
		...
		case "consultaCampanasActivas":

			q = consultaCampanasActivas(entityManager);
	...
	public void consultaCampanasActivas() {
		consulta = "consultaCampanasActivas";

	}

	private Query consultaCampanasActivas(EntityManager entityManager) {
		Query q = entityManager.createQuery("SELECT c from Campana as c where status=1");
