...
public class UsuarioDao implements MonitorDao {
	...
	public List consultar(Filtros filtrosUsuario) throws Exception {
		...
		StringBuffer queryString = new StringBuffer(
				"select u,cl from Usuario as u inner join CliPro as cl on (u.id.cliPro=cl.cveClipro)");

		if (((FiltrosUsuario) filtrosUsuario).getCveClipro() != null
				&& ((FiltrosUsuario) filtrosUsuario).getCveClipro().length() > 0) {
			queryString.append(" and ");
			queryString.append(" lower(u.id.cliPro) like lower(:cliente)");
		}
		if (((FiltrosUsuario) filtrosUsuario).getEmail() != null
				&& ((FiltrosUsuario) filtrosUsuario).getEmail().length() > 0) {
			queryString.append(" and ");
	...
	public void actualizar(Filtros filtrosUsuario) throws Exception {
		...
		if (((FiltrosUsuario) filtrosUsuario).getNombre() != null
				&& ((FiltrosUsuario) filtrosUsuario).getNombre().length() > 0) {
			queryString.append(" nombre = :nombre,");
		}
		if (((FiltrosUsuario) filtrosUsuario).getApellidos() != null
				&& ((FiltrosUsuario) filtrosUsuario).getApellidos().length() > 0) {
			queryString.append(" apellidos = :apellidos,");
		}
		if (((FiltrosUsuario) filtrosUsuario).getContrasena() != null
				&& ((FiltrosUsuario) filtrosUsuario).getContrasena().length() > 0) {
		...
		if (((FiltrosUsuario) filtrosUsuario).getTipo() != null && (((FiltrosUsuario) filtrosUsuario).getTipo() > 0
				&& ((FiltrosUsuario) filtrosUsuario).getTipo() < 4)) {
			queryString.append(" tipo = :tipo,");
		}
		if (((FiltrosUsuario) filtrosUsuario).getStatus() != null && (((FiltrosUsuario) filtrosUsuario).getStatus() > 0
				&& ((FiltrosUsuario) filtrosUsuario).getStatus() < 3)) {
		...
		try {
			...
			if (((FiltrosUsuario) filtrosUsuario).getStatus() != null
					&& (((FiltrosUsuario) filtrosUsuario).getStatus() > 0
							&& ((FiltrosUsuario) filtrosUsuario).getStatus() < 3)) {
